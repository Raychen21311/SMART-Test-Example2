# SMART on FHIR Patient Health Dashboard <br> 病患健康數據整合應用儀表板 [🔗](https://raychen21311.github.io/SMART-Test-Example2/)
...
1.  **Client ID**：
    ...
    ```
2.  **部署**：
    本專案為主要為前端應用，可部署於任何支援 HTTPS 的靜態網頁伺服器（如 GitHub Pages 或 Vercel），歡迎開發者參考使用或依需求為基礎進行改寫與擴充。
3.  **運行**：
